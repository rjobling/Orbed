...
#define debug_text(left, top, color, ...)
...
__attribute__((always_inline)) inline unsigned int muluw32(unsigned short a, unsigned short b) {
	unsigned int r = a;
	asm("muluw %1,%0":"+d"(r): "mid"(b): "cc");
	return r;
}
__attribute__((always_inline)) inline int mulsw32(short a, short b) {
	int r = a;
	asm("mulsw %1,%0":"+d"(r): "mid"(b): "cc");
	return r;
}
__attribute__((always_inline)) inline unsigned short muluw16(unsigned short a, unsigned short b) {
	asm("muluw %1,%0":"+d"(a): "mid"(b): "cc");
	return a;
}
__attribute__((always_inline)) inline short mulsw16(short a, short b) {
...
__attribute__((always_inline)) inline unsigned short divuwr(unsigned short* r, unsigned int a, unsigned short b) {
	asm("divuw %1,%0\n move.l %0,%2\n swap %2":"+d"(a): "mid"(b), "mid"(*r): "cc");
	return a;
}
__attribute__((always_inline)) inline short divswr(short* r, int a, short b) {
	asm("divsw %1,%0\n move.l %0,%2\n swap %2":"+d"(a): "mid"(b), "mid"(*r): "cc");
	return a;
}
__attribute__((always_inline)) inline unsigned short moduw(unsigned int a, unsigned short b) {
	asm("divuw %1,%0\n swap %0":"+d"(a): "mid"(b): "cc");
	return a;
}
__attribute__((always_inline)) inline short modsw(int a, short b) {
	asm("divsw %1,%0\n swap %0":"+d"(a): "mid"(b): "cc");
	return a;
}
